<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'id_order',array('class'=>'span5')); ?>

		<?php echo $form->textFieldGroup($model,'id_report',array('class'=>'span5')); ?>

		<?php echo $form->textFieldGroup($model,'id_user',array('class'=>'span5')); ?>
		...
		<?php echo $form->textFieldGroup($model,'budget',array('class'=>'span5')); ?>
